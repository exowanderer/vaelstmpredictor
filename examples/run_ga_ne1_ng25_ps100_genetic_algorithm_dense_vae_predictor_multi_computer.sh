...
python genetic_algorithm_dense_vae_predictor_multi_computer.py \
	--run_name ga_ne1_ng25_ps100_vae_predictor_multi_computer \
	--num_epochs 1 \
	--num_generations 25 \
	--population_size 100 \
	--verbose \
	--do_log \
	--do_ckpt | ssh 172.16.50.163 "tee -a /home/acc/github/vaelstmpredictor/examples/output_ga_run_ne1_ng25_ps100_genetic_algorithm_dense_vae_predictor_multi_computer_172.16.50.187.txt"
