...
python genetic_algorithm_dense_vae_predictor_multi_computer.py \
	...
	--verbose \
	--do_log \
	--do_ckpt | ssh 172.16.50.163 "tee -a /home/acc/github/vaelstmpredictor/examples/output_ga_run_test_ne1_ng2_ps3_genetic_algorithm_dense_vae_predictor_multi_computer_172.16.50.187.txt"
