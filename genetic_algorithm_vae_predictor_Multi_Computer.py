...
def train_chromosome(chromosome, machine, queue, port=22, logdir='train_logs',
    ...
    print("Pickle file {} uploaded to {}".format(param_filename, 
                                                 machine['host']))

    command = "cd vaelstmpredictor; ../anaconda3/envs/tf_gpu/bin/python "\
                "run_chromosome.py --generationID {} --chromosomeID {}".format(
