...
from GeneticAlgorithm import generate_random_chromosomes, train_generation, create_blank_dataframe, select_parents, cross_over, mutate
...
if __name__ == '__main__':
    ...
    generation = train_generation(
        generation, clargs, verbose=verbose, sleep_time=sleep_time)
    best_fitness = []
    ...
    for generationID in range(1, num_generations):
        ...
        for chromosomeID in tqdm(range(population_size)):
            ...
            print("Start")
            print("Chrom", chromosomeID, generation.loc[
                  chromosomeID, ["size_dnn_hidden", "size_vae_hidden"]])
