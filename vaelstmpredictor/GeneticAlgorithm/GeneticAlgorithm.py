...
def cross_over(new_generation, generation, parent1, parent2, 
	...
	if random.random() <= prob:
		...
		for param in param_choices:
			...
			debug_message('cross_over+paramloop+p1_param:{},{}'.format(p1_param, p2_param))
			debug_message('cross_over+paramloop+p1_param:{},{}'.format(generation.iloc[idx_parent1][param]))
			debug_message('cross_over+paramloop+p2_param:{},{}'.format(p2_param))
			debug_message('cross_over+paramloop+p1_param:{},{}'.format(generation.iloc[idx_parent2][param]))
